					...
					<div className="md:ml-4">
						<header className="">
							...
							<p className="font-light text-base text-white dark:text-gray-200  mt-2">
								See my contact details below or send me an email
								to get in touch.
							</p>
						</header>
						<div className="icons-container inline-flex flex-col my-20">
							<div className=" mb-5 flex flex-row w-80 items-center space-x-6 rounded-md border border-blue-500 hover:border hover:border-white  p-4">
								<svg
									...
									height="16"
									fill="currentColor"
									className="bi bi-telephone-fill h-4 w-4 text-primary-dark"
									viewBox="0 0 16 16"
								>
									<path
										fillRule="evenodd"
							...
							<div className="mb-5 flex flex-row w-80 items-center space-x-6 rounded-md border border-blue-500 hover:border hover:border-white p-4">
								<svg
									...
									height="16"
									fill="currentColor"
									className="bi bi-envelope-fill h-4 w-4 text-primary-dark"
									viewBox="0 0 16 16"
								>
							...
							<div className="flex flex-row items-center w-80 space-x-6 rounded-md border border-blue-500 hover:border hover:border-white p-4">
								<svg
									...
									height="16"
									fill="currentColor"
									className="bi bi-pin-fill h-4 w-4 text-primary-dark"
									viewBox="0 0 16 16"
								>
